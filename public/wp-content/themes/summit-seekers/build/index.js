...
function IconGrid() {
  const {
    posts,
    loading
  } = (0,_functions_js__WEBPACK_IMPORTED_MODULE_1__.useFetchPosts)("Icon");
  if (loading) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    key: post.id
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, post.title.rendered), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const useFetchPosts = categoryName => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const fetchPosts = async () => {
      ...
      if (categoryId) {
        fetch(`http://cms.localhost/wp-json/wp/v2/posts?categories=${categoryId}&_embed`).then(response => response.json()).then(data => {
          setPosts(data);
          setLoading(false);
        }).catch(error => {
...
/* harmony import */ var _scripts_IconGrid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/IconGrid */ "./src/scripts/IconGrid.js");
...
react_dom__WEBPACK_IMPORTED_MODULE_4___default().render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_scripts_IconGrid__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.querySelector("#render-react-example-here"));
})();
